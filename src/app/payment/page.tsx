    ...
    <div className="payment w-full bg-[#f6f7f9] p-4 sm:p-6  flex flex-wrap gap-6 justify-center font-[family-name:var(--font-geist-sans)]">
      <div className="cards w-full md:w-[70%] grid grid-cols-1 gap-6 order-2 lg:order-1">
        ...
        <Card className="w-full lg:w-[852px] h-auto lg:h-[664px] flex flex-col justify-around">
          ...
          <CardContent className="flex flex-col gap-6">
            <div className="first">
              <Image src={"/assets/Pick Up1.png"} alt="Pick Up" width={92} height={20} />
            </div>
            <div className="w-full flex flex-wrap gap-4">
              <div className="add flex flex-col gap-3 w-full lg:w-[46%]">
            ...
            <div className="fourth">
              <Image src={"/assets/Drop - Off (1).png"} alt="Drop Off" width={104} height={20} />
            </div>
        ...
        <Card className="w-full lg:w-[852px] h-auto lg:h-[596px] flex flex-col justify-around">
          ...
          <CardContent className="flex flex-col gap-6">
            <Image src={"/assets/Credit Card.png"} alt="Credit Card" width={804} height={308} />
            <Image src={"/assets/PayPal.png"} alt="PayPal" width={804} height={56} />
            <Image src={"/assets/Bitcoin.png"} alt="Bitcoin" width={804} height={56} />
          </CardContent>
        </Card>
        ...
        <Card className="w-full lg:w-[852px] h-auto lg:h-[484px] flex flex-col justify-around">
          ...
          <CardContent className="flex flex-col gap-8">
            <Image src={"/assets/Confirmation.png"} alt="Confirmation" width={804} height={136} />
            <Link href={'/admin'}>
            <button className="bg-[#3563e9] p-2 text-white rounded-xl w-[140px] h-[56px]">
              Rent Now
            </button></Link>
            
            <Image src={"/assets/Safe Data.png"} alt="Safe Data" width={548} height={100} />
          </CardContent>
        </Card>
      </div>
      <div className="details w-full flex-shrink-0 lg:w-[40%] order-1 lg:order-2 flex justify-center">
        <Image src={"/assets/Rental Summary.png"} alt="Rental Summary" width={492} height={568} className=" lg:w-[492px] h-[568px]"  />
      </div>
    </div>
  );
}
