  ...
  return (
    <div className="w-full flex flex-col md:flex-row">
      ...
      <div className="small-screens md:hidden bg-[#f6f7f9] p-4 sm:p-6 flex flex-col gap-6">
        ...
        />
        <Image
          src={"/assets/Recent Transaction.png"}
